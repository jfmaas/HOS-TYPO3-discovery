...
Currently all new components are realized with pure jQuery. This [page](/subhh/HOS-TYPO3-discovery/blob/master/Documentation/Addingfacettype.md) describes the clean, TYPO3-conform way.
